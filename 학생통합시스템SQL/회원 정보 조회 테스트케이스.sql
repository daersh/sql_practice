-- ---------------------------------------- 회원 관련 ---------------------------------------- --
-- 1. 자신이 아닌 다른 학생 정보 조회 시: 회원의 학번,이름,학과,영어이름,학생사진,성별,입학년도,졸업년도,학년,학적상태까지만 조회 가능 --
-- 2. 학생 자신 정보를 조회: 모든 것을 조회 가능
-- 3. 담당 교수가 자신의 학생 조회 시: 비밀번호,주민번호를 제외한 모든 정보 조회 가능
-- 4. 자신이 아닌 다른 교수의 정보 조회 시: 교수코드, 비밀번호, 주민번호, 계약형태, 급여를 제외한 정보 조회 가능
-- 5. 담당 교수가 자신의 정보 조회 시: 전부 조회 가능
